 ...
 */
import { getConnectionStatus, subscribeToMessages, setSocket, connect, join, sendMessage, leaveRoom, disconnect } from './socketConnection.js'
import { createSendingPeer, createReceivingPeer } from './videoCall.js'
 ...
 */
export function start (onLocalStream, mediaConstraintsOptions = null) {
	...
	createSendingPeer(iceServers, mediaConstraints, onLocalStream,
		(iceCandidate) => {
...
export function createNewReceivingPeer (socketID, videoElement) {
	const iceServers = [turnServer]
 ...
 */
export function startRecording (videoCallID = null, recordingType = 1) {
